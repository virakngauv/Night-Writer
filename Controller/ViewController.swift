...
//        print("end of receiveTextInput")
    ...
    func createMessage (){
        ...
        messageArray.append(UIImage(named: "blue")!)
        messageArray.append(UIImage(named: "blue")!)
        //had 2 extra frames here for some reason.. don't remember if they are supposed to be there.. (I added 20 to total # of frames, but red:10 and blue:12? so I made blue:10)
